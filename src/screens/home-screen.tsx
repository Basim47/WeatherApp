  ...
  return (
    <View className="flex-1">
      ...
      {isLoading ? <View className="flex-1 item-center justify-center">
        ...
        <KeyboardAwareScrollView keyboardShouldPersistTaps='handled' keyboardDismissMode='interactive'>
          <SafeAreaView className="flex flex-1">
            ...
            <View style={{ height: "7%" }} className="mx-4 relative z-50">
              ...
              {locations.length > 0 && showSearch ? (
                <View className="absolute w-full bg-gray-300 top-16 rounded-3xl mt-10">
            ...
            {/* Forecast Section */}
            <View className="mx-4 flex justify-around flex-1 mb-8 mt-16">
              {/* Location */}
